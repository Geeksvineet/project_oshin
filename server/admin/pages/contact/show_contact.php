...
$countQuery = "SELECT COUNT(id) FROM contact";
...
<head>
    ...
    <title>All Contacts - Oshin Sports Academy</title>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="text-center">All Contact Details</h2>
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td>
                    <a href='delete_contact?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this Contact details?\");'>Delete</a>
                  </td>";
                                                    echo "</tr>";
                                                }
                                            } else {
