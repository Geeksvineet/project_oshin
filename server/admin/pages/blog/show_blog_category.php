...
$sql = "SELECT * FROM blog_category LIMIT $start, $limit";
...
$countQuery = "SELECT COUNT(id) FROM blog_category";
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="container mt-5">
                        <h2 class="text-center">All Blog Categories</h2>
                        <a href="add_blog_category" class="btn btn-primary mb-3">Add New Blog Category</a>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>
                            <a href='edit_blog_category?id=" . $row['id'] . "' class='btn btn-warning btn-sm'>Edit</a>
                            <a href='delete_blog_category?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this category?\");'>Delete</a>
                          </td>";
                                            echo "</tr>";
                                        }
                                    } else {
