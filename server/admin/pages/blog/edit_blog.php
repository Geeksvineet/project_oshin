...
$categorySql = "SELECT * FROM blog_category";
...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['image']['name']) {
        ...
        $updateSql = "UPDATE blog SET title='$title', description='$description', category='$category', image='$target', date_updated='$date_updated' WHERE id=$id";
    } else {
        // If image is not updated, keep the old image
        $updateSql = "UPDATE blog SET title='$title', description='$description', category='$category', date_updated='$date_updated' WHERE id=$id";
    }
