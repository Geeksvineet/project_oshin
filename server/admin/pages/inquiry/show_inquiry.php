...
$sql = "SELECT * FROM inquiry LIMIT $start, $limit";
...
$countQuery = "SELECT COUNT(id) FROM inquiry";
...
<head>
    ...
    <title>All Inquiries - Oshin Sports Academy</title>
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td>
                    <a href='delete_inquiry?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this Enquiry ?\");'>Delete</a>
                  </td>";
                                                    echo "</tr>";
                                                }
                                            } else {
                                    ...
                                    <ul class="pagination justify-content-center">
                                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                            <li class="page-item <?php if ($page == $i) echo 'active'; ?>">
                                                <a class="page-link" href="show_inquiry?page=<?= $i; ?>"><?= $i; ?></a>
                                            </li>
                                        <?php endfor; ?>
                                    </ul>
                                </nav>
