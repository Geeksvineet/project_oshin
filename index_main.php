...
<body class="custom-cursor">
    ...
    <div class="preloader">
        <div class="box">
            <!-- <img width="20%"  src="client/assets/images/ball-removebg-preview.png" alt=""> -->
            <div class="cat">
                <!-- <img src="client/assets/images/ball-removebg-preview.png" alt=""> -->
                ...
                <div class="topbar-one__inner">
                    ...
                    <ul class="list-unstyled topbar-one__info">
                        <li class="topbar-one__info__item">
                            ...
                            <a href="#">4th floor, Genius Temple, New Palasia, Indore, Madhya Pradesh 452001</a>
                        </li>
                        <li class="topbar-one__info__item">
                            <i class="fas fa-envelope topbar-one__info__icon"></i>
                            <a href="mailto:info@oshinsportsacademy.com">info@oshinsportsacademy.com</a>
                        </li>
                    </ul>
                        ...
                        <ul class="main-menu__list">
                            ...
                            <li class="dropdown">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="client/gallery-filter">Gallery Filter</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                    ...
                    <div class="col-lg-7">
                        <div class="video-one__btn-shape">
                            <div class="video-one__btn">
                                <img
                                    src="client/assets/images/backgrounds/video-bg-1.jpg"
                                    alt="kidearn" />
                                <a
                            ...
                            <div class="footer-widget footer-widget--about">
                                ...
                                <ul class="list-unstyled footer-widget__info">
                                    <li>
                                        ...
                                        <a href="#">4th floor, Genius Temple, New Palasia, Indore 452001</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="footer-widget footer-widget--gallery">
                                ...
                                <form action="client/submit_inquiry" method="POST" onsubmit="submitFooterForm(event)">
                                    ...
                                    <button style="width: 90%;" type="submit" class="kidearn-btn main-header__btn"><span style="width: 90%; text-align: center;">Submit</span></button>
    ...
    <div id="popupBackground">
        <div id="popupForm">
            ...
            <form id="inquiryForm" action="client/submit_inquiry" method="POST" onsubmit="submitForm(event)">
                ...
                <button style="width: 100%;" type="submit" class="kidearn-btn main-header__btn"><span style="width: 100%; text-align: center;">Submit</span></button>
            </form>
        </div>
    </div>
